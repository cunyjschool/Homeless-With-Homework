...
<div class="form-left">
<input type="text" name="author" id="author" tabindex="1" value="<?php _e('Name (required)',woothemes); ?>" onfocus="if (this.value == '<?php _e('Name (required)',woothemes); ?>') {this.value = '';}" onblur="if (this.value == '') {this.value = '<?php _e('Name (required)',woothemes); ?>';}" />
<input type="text" name="email" id="email" tabindex="2" value="<?php _e('Email (required)',woothemes); ?>" onfocus="if (this.value == '<?php _e('Email (required)',woothemes); ?>') {this.value = '';}" onblur="if (this.value == '') {this.value = '<?php _e('Email (required)',woothemes); ?>';}" />
<input type="text" name="url" id="url" tabindex="3" value="<?php _e('Website (optional)',woothemes); ?>" onfocus="if (this.value == '<?php _e('Website (optional)',woothemes); ?>') {this.value = '';}" onblur="if (this.value == '') {this.value = '<?php _e('Website (optional)',woothemes); ?>';}" />
<div class="cancel-comment-reply">
	<small><?php cancel_comment_reply_link(); ?></small>
</div>
